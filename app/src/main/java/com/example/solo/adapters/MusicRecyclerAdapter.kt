...
import com.example.solo.interfaces.OnItemClickListner
...
import com.example.solo.main_fragments.SongListsFragmentDirections
...
//            adapterPF= PlaylistsRecyclerAdapter(playlistFiles,view)
        ...
        holder.setOnItemClicklistner(object : OnItemClickListner {
            override fun onItemClickListner(view: View, pos: Int) {
                ...
                if (value == 1) {
                    musicServices!!.songSelectionList(1)
...
//                    navController.navigate(actions)
                    ...
                    musicServices!!.songSelectionList(2)
//                    var actions: NavDirections =
...
//                    navController.navigate(actions)
                    ...
                    musicServices!!.songSelectionList(3)
//                    var actions: NavDirections =
